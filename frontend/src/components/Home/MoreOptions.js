...
function MoreOptions({onClose,onDelete,onShare})  {
  ...
  return (
    <motion.div
      ...
      <div onClick={handleFavourite} className=" text-white cursor-pointer transition-all rounded-md py-2 px-3 flex w-full items-center justify-start gap-2  hover:bg-white hover:bg-opacity-5 "><img className=" w-4 transition-all" src={isFavorite?"/star-filled.png":"/star.png"}/>Add to Favourites</div>
